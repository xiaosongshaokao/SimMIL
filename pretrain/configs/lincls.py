...
class LinClsParser(BaseParser):
    def __init__(self):
        ...
        self.parser.add_argument('--bag_label_dir', '-bld', default='/remote-home/kongyijian/MIL/SimMIL/data/TCGA_C16_BRCA',
         type=str, help='Omitted if not using NCTCRC-BAGS')
        ...
        self.parser.add_argument('--wd', '--weight-decay', default=0., type=float,
                            ...
                            dest='weight_decay')
        self.parser.add_argument('--tem', default=1.0, type=float,
                            help='tempature for loss function')
        ...
        self.parser.add_argument('--eval_class_num', '-ecn',  type=int, default=2,
        ...
        self.parser.add_argument("--test_selected_images", type=str, default="/remote-home/share/GraphMIL/samples/camelyon16/test_dataset.npy")
        self.parser.add_argument("--test_selected_labels", type=str, default="/remote-home/share/GraphMIL/samples/camelyon16/test_label.npy")
