...
class MeanTeacherParser(BaseParser):
    def __init__(self):
        super().__init__()
        self.parser.add_argument('--labels', default='/remote-home/kongyijian/GraphMIL/samples/nctcrc/49995_balanced_labels/08.txt', type=str, metavar='FILE',
                            help='list of image labels (default: based on directory structure)')
        self.parser.add_argument('--labeled-batch-size', default=32, type=int,
