...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='/remote-home/kongyijian/GraphMIL/backbone_check/debug/added_0726/target8/model_best.pth', type=str, help="""Path to pretrained 
    ...
    parser.add_argument('--output_dir', default="/remote-home/kongyijian/GraphMIL/backbone_check/debug/eval/target8", help='Path to save logs and checkpoints')
