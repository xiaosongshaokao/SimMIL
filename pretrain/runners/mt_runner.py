...
from core.mean_teacher import architectures, augmentations, data, losses, ramps, cli
from core.mean_teacher.model import MeanTeacher
from core.mean_teacher.data import NO_LABEL, TwoStreamDataLoader
from datasets.my_imagefolder import MyImageFolder

class MeanTeacherRunner(LinClsRunner):
    ...
    def build_data_loaders(self):
        ...
        eval_loader = torch.utils.data.DataLoader(
            MyImageFolder(evaldir, eval_transformation),
